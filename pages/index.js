export default function Home() {
  return (
    <div className='flex h-screen w-full flex-col items-center bg-gray-100 px-8 py-4'>
      <h1 className='mb-10 w-full rounded-xl bg-white px-8 py-4 text-center text-3xl font-bold shadow-lg'>
      ...
      <div className='w-1/2 rounded-xl bg-white p-8 '>
        <div className='flex w-full flex-col items-center justify-center gap-y-6 rounded-lg'>
          {/* Task #1 */}
          <div className='flex w-full items-center justify-between rounded-lg border border-slate-300 p-6 shadow-sm hover:shadow-lg'>
            <p className='text-lg font-medium text-slate-800'>Task 1</p>
          ...
          {/* Task #2 */}
          <div className='flex w-full items-center justify-between rounded-lg border border-slate-300 p-6 shadow-sm hover:shadow-lg'>
            <p className='text-lg font-medium text-slate-800'>Task 2</p>
            <div className='flex items-center gap-x-4'>
              {/* Check */}
              <button>
                <svg
